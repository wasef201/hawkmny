	...
	<div class="card shadow-none rounded-0 w-100">
		...
		<div class="card-header" id="kt_engage_demos_header">
			...
			<div class="card-toolbar">
				<button type="button" class="btn btn-sm btn-icon btn-active-color-success h-40px w-40px me-n6" id="kt_engage_demos_close">
		...
		<div class="card-body" id="kt_engage_demos_body">
			...
			<div
                ...
                <div class="mb-0">
					...
					<!--begin::Purchase-->
					<a href="{{ theme()->getOption('product', 'purchase') }}" class="btn btn-success mb-15 w-100">
						Buy Now
					</a>
					<!--end::Purchase-->
