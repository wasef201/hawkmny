    ...
    <div class="tab-content">
        ...
        <div class="tab-pane fade" id="kt_topbar_notifications_1" role="tabpanel">
                ...
                <?php foreach($alerts as $alert):?>
                    ...
                    <div class="d-flex flex-stack py-4">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Title-->
                            <div class="mb-0 me-2">
                                <a href="#" class="fs-6 text-gray-800 text-hover-success fw-bolder">{{ $alert['title'] }}</a>
			...
			<div class="py-3 text-center border-top">
                <a href="{{ theme()->getPageUrl('pages/profile/activity') }}" class="btn btn-color-gray-600 btn-active-color-success">
                    View All
            ...
            <div class="d-flex flex-column px-9">
                ...
                <div class="pt-10 pb-0">
                    ...
                    <div class="text-center mt-5 mb-9">
                        <a href="#" class="btn btn-sm btn-success px-6" data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan">Upgrade</a>
                    </div>
                    <!--end::Action-->
                </div>
                <!--end::Section-->
                ...
                <?php foreach($logs as $log):?>
                    ...
                    <div class="d-flex flex-stack py-4">
                        ...
                        <div class="d-flex align-items-center me-2">
                            ...
                            <!--begin::Title-->
                            <a href="#" class="text-gray-800 text-hover-success fw-bold">{{ $log['message'] }}</a>
                            <!--end::Title-->
                        </div>
                        <!--end::Section-->
