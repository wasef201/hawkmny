	...
	<div class="card shadow-none">
		...
		<div class="card-header" id="kt_activities_header">
			...
			<div class="card-toolbar">
				<button type="button" class="btn btn-sm btn-icon btn-active-light-success me-n5" id="kt_activities_close">
		...
		<div class="card-footer py-5 text-center" id="kt_activities_footer">
			<a href="{{ theme()->getPageUrl('pages/profile/activity') }}" class="btn btn-bg-white text-success">
				View All Activities {!! theme()->getSvgIcon("icons/duotune/arrows/arr064.svg", "svg-icon-3 svg-icon-success") !!}
			</a>
		</div>
		<!--end::Footer-->
	</div>
