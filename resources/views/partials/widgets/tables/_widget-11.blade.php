                ...
                <tbody>
                    @foreach($tableRows as $row)
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex justify-content-start flex-column">
                                        <a href="#" class="text-dark fw-bolder text-hover-success mb-1 fs-6">{{ $row['product']['name'] }}</a>
                            ...
                            <td>
                                <a href="#" class="text-dark fw-bolder text-hover-success d-block mb-1 fs-6">{{ $row['deposit'] }}</a>
                                <span class="text-muted fw-bold text-muted d-block fs-7">Rejected</span>
                            </td>

                            <td>
                                <a href="#" class="text-dark fw-bolder text-hover-success d-block mb-1 fs-6">{{ $row['agent']['name'] }}</a>
