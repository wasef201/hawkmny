...
<div class="card {{ $class }}">
    ...
    <div class="card-header border-0 pt-5">
        ...
        <div class="card-toolbar">
            <!--begin::Menu-->
            <button type="button" class="btn btn-sm btn-icon btn-color-success btn-active-light-success" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                ...
                <tbody>
                    @foreach($tableRows as $row)
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex justify-content-start flex-column">
                                        <a href="#" class="text-dark fw-bolder text-hover-success mb-1 fs-6">{{ $row['agent']['name'] }}</a>
                            ...
                            <td>
                                <a href="#" class="text-dark fw-bolder text-hover-success d-block mb-1 fs-6">{{ $row['earnings']['value'] }}</a>
                                <span class="text-muted fw-bold text-muted d-block fs-7">{{ $row['earnings']['remarks'] }}</span>
                            </td>

                            <td>
                                <a href="#" class="text-dark fw-bolder text-hover-success d-block mb-1 fs-6">{{ $row['comission']['value'] }}</a>
                                <span class="text-muted fw-bold text-muted d-block fs-7">{{ $row['comission']['remarks'] }}</span>
                            </td>

                            <td>
                                <a href="#" class="text-dark fw-bolder text-hover-success d-block mb-1 fs-6">{{ $row['company']['name'] }}</a>
                            ...
                            <td class="text-end">
                                <a href="#" class="btn btn-bg-light btn-color-muted btn-active-color-success btn-sm px-4 me-2">
                                    View
                                </a>

                                <a href="#" class="btn btn-bg-light btn-color-muted btn-active-color-success btn-sm px-4">
                                    Edit
                                </a>
                            </td>
                        </tr>
