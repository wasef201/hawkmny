...
<div class="card {{ $class }}">
    ...
    <div class="card-header border-0 pt-5">
        ...
        <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="Click to add a user">
            <a href="#" class="btn btn-sm btn-light-success" data-bs-toggle="modal" data-bs-target="#kt_modal_invite_friends">
                ...
                <tbody>
                    @foreach($tableRows as $row)
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex justify-content-start flex-column">
                                        <a href="#" class="text-dark fw-bolder text-hover-success fs-6">{{ $row['user']['name'] }}</a>
                            ...
                            <td>
                                <a href="#" class="text-dark fw-bolder text-hover-success d-block fs-6">{{ $row['company']['name'] }}</a>
