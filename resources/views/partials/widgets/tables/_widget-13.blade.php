                ...
                <tbody>
                    @foreach($tableRows as $row)
                        <tr>
                            ...
                            <td>
                                <a href="#" class="text-dark fw-bolder text-hover-success fs-6">{{ $row['orderid'] }}</a>
                            </td>

                            <td>
                                <a href="#" class="text-dark fw-bolder text-hover-success d-block mb-1 fs-6">{{ $row['country']['name'] }}</a>
                                <span class="text-muted fw-bold text-muted d-block fs-7">Code: {{ $row['country']['code'] }}</span>
                            </td>

                            <td>
                                <a href="#" class="text-dark fw-bolder text-hover-success d-block mb-1 fs-6">{{ $row['date']['value'] }}</a>
                            ...
                            <td class="text-dark fw-bolder text-hover-success fs-6">
                                {{ $row['total'] }}
                            </td>
