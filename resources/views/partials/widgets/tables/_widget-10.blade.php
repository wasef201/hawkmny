                ...
                <tbody>
                    @foreach($tableRows as $index => $row)
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex justify-content-start flex-column">
                                        <a href="#" class="text-dark fw-bolder text-hover-success mb-1 fs-6">{{ $user['name'] }}</a>

                                        <a href="#" class="text-muted text-hover-success fw-bold text-muted d-block fs-7">
                            ...
                            <td class="text-end">
                                <a href="#" class="text-dark fw-bolder text-hover-success d-block mb-1 fs-6">{{ $row['price'] }}</a>
