@php
    ...
    $toolbarButtonHeightClass = "btn-custom w-30px h-30px w-md-40px h-md-40px";
...
<div class="topbar d-flex align-items-stretch flex-shrink-0">
   ...
   {{-- <div class="d-flex align-items-stretch {{ $toolbarButtonMarginClass }}">
    ...
    {{--<div class="d-flex align-items-center {{ $toolbarButtonMarginClass }}">
        <!--begin::Drawer toggle-->
        <div class="btn btn-icon btn-active-light-success {{ $toolbarButtonHeightClass }}" id="kt_activities_toggle">
...
{{--    <div class="d-flex align-items-center {{ $toolbarButtonMarginClass }}">--}}
{{--        <!--begin::Menu wrapper-->--}}
{{--        <div class="btn btn-icon btn-active-light-success {{ $toolbarButtonHeightClass }}" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">--}}
...
{{--    </div>--}}
   ...
   {{-- <div class="d-flex align-items-center {{ $toolbarButtonMarginClass }}">
        <!--begin::Menu wrapper-->
        <div class="btn btn-icon btn-active-light-success position-relative {{ $toolbarButtonHeightClass }}" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
    ...
    <div class="d-flex align-items-center me-n3 {{ $toolbarButtonMarginClass }}" id="kt_header_user_menu_toggle">
        <!--begin::Menu wrapper-->
        <div class="btn btn-icon btn-light-success btn-active-light-success {{ $toolbarButtonHeightClass }}" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
            <img class="h-25px w-25px" src="{{ asset('icons/favicon-32x32.png') }}" alt="avatar"/>
        </div>
    ...
    @if (theme()->getOption('layout', 'aside/display') === true)
        <div class="d-flex align-items-center d-lg-none ms-4" title="Show header menu">
            <div class="btn btn-icon btn-active-light-success {{ $toolbarButtonHeightClass }}" id="kt_aside_mobile_toggle">
