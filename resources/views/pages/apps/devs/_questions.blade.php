    ...
    @foreach($questions as $question)
        ...
        <div class="mb-0">
            ...
            <div class="d-flex align-items-center mb-4">
                <!--begin::Title-->
                <a href="{{ theme()->getPageUrl('apps/devs/question') }}" class="fs-2 fw-bolder text-gray-900 text-hover-success me-1">
                    {{ $question['title'] }}
                </a>
                <!--end::Title-->
...
<div class="d-flex flex-center mb-0">
    @foreach($pagination as $page)
        ...
        <?php else:?>
            <a href="#" class="btn btn-icon btn-light btn-active-light-success h-30px w-30px fw-bold fs-6 mx-2 {{ $page == '2' ? 'active' : '' }}">{{ $page }}</a>
        @endif
    @endforeach
</div>
<!--end::Questions-->
