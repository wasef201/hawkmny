<x-base-layout>
    ...
    <form id="kt_devs_reply_form" class="form mb-10" action="#">
        ...
        <div class="d-flex align-items-center justify-content-between py-2 mb-5">
            ...
            <div class="text-success fs-base fw-bold cursor-pointer" data-bs-toggle="collapse" data-bs-target="#kt_devs_ask_formatting">
                Text formatting options
            </div>
            <!--end::Formating toggle-->

            <!--begin::Submit-->
            <button class="btn btn-success fw-bolder" data-kt-action="submit">Submit</button>
            <!--end::Submit-->
        </div>
        <!--end::Action-->
