...
<div class="timeline-item">
    ...
    <div class="timeline-content mb-10 mt-n1">
        ...
        <div class="mb-5 pe-3">
            <!--begin::Title-->
            <a href="#" class="fs-5 fw-bold text-gray-800 text-hover-success mb-2">3 New Incoming Project Files:</a>
            <!--end::Title-->
            ...
            <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
                ...
                <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                    ...
                    <div class="ms-1 fw-bold">
                        <!--begin::Desc-->
                        <a href="#" class="fs-6 text-hover-success fw-bolder">Finance KPI App Guidelines</a>
                        <!--end::Desc-->
                ...
                <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                    ...
                    <div class="ms-1 fw-bold">
                        <!--begin::Desc-->
                        <a href="#" class="fs-6 text-hover-success fw-bolder">Client UAT Testing Results</a>
                        <!--end::Desc-->
                ...
                <div class="d-flex flex-aligns-center">
                    ...
                    <div class="ms-1 fw-bold">
                        <!--begin::Desc-->
                        <a href="#" class="fs-6 text-hover-success fw-bolder">Finance Reports</a>
                        <!--end::Desc-->
