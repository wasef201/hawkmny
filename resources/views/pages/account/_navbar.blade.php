    ...
    <div class="card-body pt-9 pb-0">
                ...
                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            <a href="#" class="text-gray-800 text-hover-success fs-2 fw-bolder me-1">{{ auth()->user()->name }}</a>
                            <a href="#">
                                {!! theme()->getSvgIcon("icons/duotune/general/gen026.svg", "svg-icon-1 svg-icon-success") !!}
                            </a>
                        ...
                        <div class="d-flex flex-wrap fw-bold fs-6 mb-4 pe-2">
                            <a href="#" class="d-flex align-items-center text-gray-400 text-hover-success me-5 mb-2">
                            ...
                            <a href="#" class="d-flex align-items-center text-gray-400 text-hover-success mb-2">
                    ...
                    <div class="d-flex my-4">
                        ...
                        <a href="#" class="btn btn-sm btn-success me-3" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-trigger="hover" title="Coming soon">Hire Me</a>

                        <!--begin::Menu-->
                        <div class="me-0">
                            <button class="btn btn-sm btn-icon btn-bg-light btn-active-color-success" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
        ...
        <div class="d-flex overflow-auto h-55px">
            <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap">
                ...
                <!--begin::Nav item-->
                    <li class="nav-item">
                        <a class="nav-link text-active-success me-6 {{ theme()->getPagePath() === $each['view'] ? 'active' : '' }}" href="{{ $each['view'] ? theme()->getPageUrl($each['view']) : '#' }}">
                            {{ $each['title'] }}
                        </a>
                    </li>
                    <!--end::Nav item-->
