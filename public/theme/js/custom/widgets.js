                        ...
                        (e = document.querySelector("#kt_user_menu_dark_mode_toggle")) &&
                            ...
                            a &&
                                new ApexCharts(a, {
                                    ...
                                    xaxis: { categories: ["Feb", "Mar", "Apr", "May", "Jun", "Jul"], axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { style: { colors: s, fontSize: "12px" } } },
                            ...
                            (function () {
                                ...
                                e &&
                                    new ApexCharts(e, {
                                        ...
                                        plotOptions: { bar: { horizontal: !1, columnWidth: ["12%"], borderRadius: 4 } },
                                        legend: { show: !1 },
                                        dataLabels: { enabled: !1 },
                                        stroke: { show: !0, width: 2, colors: ["transparent"] },
                                        xaxis: { categories: ["Feb", "Mar", "Apr", "May", "Jun", "Jul"], axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { style: { colors: t, fontSize: "12px" } } },
                            ...
                            (function () {
                                ...
                                e &&
                                    new ApexCharts(e, {
                                        ...
                                        plotOptions: { bar: { stacked: !0, horizontal: !1, borderRadius: 4, columnWidth: ["12%"] } },
                                        legend: { show: !1 },
                                        dataLabels: { enabled: !1 },
                                        ...
                                        colors: [o, r, s],
                                        grid: { borderColor: a, strokeDashArray: 4, yaxis: { lines: { show: !0 } }, padding: { top: 0, right: 0, bottom: 0, left: 0 } },
                                    }).render();
                            })(),
                            (function () {
                                ...
                                e &&
                                    new ApexCharts(e, {
                                        ...
                                        colors: [r, l, c],
                                        grid: { borderColor: o, strokeDashArray: 4, yaxis: { lines: { show: !0 } } },
                                        markers: { colors: [i, n, d], strokeColor: [r, l, c], strokeWidth: 3 },
                                    }).render();
                            })(),
                            (function () {
                                ...
                                e &&
                                    new ApexCharts(e, {
                                        ...
                                        dataLabels: { enabled: !1 },
                                        fill: { type: "solid", opacity: 1 },
                                        stroke: { curve: "smooth", show: !0, width: 2, colors: [r, l, c] },
                                        xaxis: {
                                            x: 0,
                                            offsetX: 0,
                                            offsetY: 0,
                                        ...
                                        markers: { colors: [r, l, c], strokeColor: [r, l, c], strokeWidth: 3 },
                                    }).render();
                            })(),
                            (function () {
                                var e,
                                    ...
                                    if (e) {
                                        ...
                                        new ApexCharts(e, {
                                            ...
                                            fill1: {
                                                type: "gradient",
                                                opacity: 1,
                                                gradient: { type: "vertical", shadeIntensity: 0.5, gradientToColors: void 0, inverseColors: !0, opacityFrom: 1, opacityTo: 0.375, stops: [25, 50, 100], colorStops: [] },
                                            },
                                            stroke: { curve: "smooth", show: !0, width: 3, colors: [r] },
                                            xaxis: {
                                                categories: ["Feb", "Mar", "Apr", "May", "Jun", "Jul"],
                            ...
                            (function () {
                                ...
                                [].slice.call(o).map(function (o) {
                                    (e = o.getAttribute("data-kt-color")),
                                        ...
                                        new ApexCharts(o, {
                                            series: [
                                                { name: "Net Profit", data: [50, 60, 70, 80, 60, 50, 70, 60] },
                                            ...
                                            dataLabels: { enabled: !1 },
                                            stroke: { show: !0, width: 2, colors: ["transparent"] },
                                            xaxis: { categories: ["Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep"], axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { style: { colors: s, fontSize: "12px" } } },
                                ...
                                [].slice.call(t).map(function (t) {
                                    (e = parseInt(KTUtil.css(t, "height"))),
                                        new ApexCharts(t, {
                                            ...
                                            chart: { fontFamily: "inherit", type: "bar", height: e, toolbar: { show: !1 }, sparkline: { enabled: !0 } },
                                            plotOptions: { bar: { horizontal: !1, columnWidth: ["30%"], borderRadius: 2 } },
                                            legend: { show: !1 },
                                            dataLabels: { enabled: !1 },
                                            ...
                                            grid: { borderColor: o, strokeDashArray: 4, yaxis: { lines: { show: !0 } }, padding: { left: 20, right: 20 } },
                                        }).render();
                                });
                            })(),
                            (function () {
                                ...
                                [].slice.call(t).map(function (t) {
                                    if (((e = parseInt(KTUtil.css(t, "height"))), t)) {
                                        ...
                                        new ApexCharts(t, {
                                            ...
                                            chart: { fontFamily: "inherit", type: "area", height: e, toolbar: { show: !1 }, zoom: { enabled: !1 }, sparkline: { enabled: !0 } },
                                            plotOptions: {},
                                            legend: { show: !1 },
                                            dataLabels: { enabled: !1 },
                                            fill: { type: "gradient", gradient: { opacityFrom: 0.4, opacityTo: 0, stops: [20, 120, 120, 120] } },
                            ...
                            (function () {
                                ...
                                [].slice.call(t).map(function (t) {
                                    ...
                                    var a = KTUtil.getCssVariableValue("--bs-gray-800");
                                    new ApexCharts(t, {
                                        series: [{ name: "Inflation", data: [1, 2.1, 1, 2.1, 4.1, 6.1, 4.1, 4.1, 2.1, 4.1, 2.1, 3.1, 1, 1, 2.1] }],
                            ...
                            (n = document.querySelector("#kt_forms_widget_1_form")) &&
                                n &&
                                new Quill("#kt_forms_widget_1_editor", { modules: { toolbar: { container: "#kt_forms_widget_1_editor_toolbar" } }, placeholder: "What is on your mind ?", theme: "snow" }),
                            (c = document.querySelector("#kt_widget_5_load_more_btn")),
                            (d = document.querySelector("#kt_widget_5")),
                            c &&
                            ...
                            (function () {
                                if ("undefined" != typeof FullCalendar && document.querySelector("#kt_calendar_widget_1")) {
                                    ...
                                    new FullCalendar.Calendar(r, {
                                        ...
                                        navLinks: !0,
                                        events: [
                                            { title: "All Day Event", start: t + "-01", description: "Toto lorem ipsum dolor sit incid idunt ut", className: "fc-event-danger fc-event-solid-warning" },
                                            ...
                                            { title: "Conference", start: a, end: s, description: "Lorem ipsum dolor eius mod tempor labore", className: "fc-event-primary" },
                                            { title: "Meeting", start: o + "T10:30:00", end: o + "T12:30:00", description: "Lorem ipsum dolor eiu idunt ut labore" },
                                            { title: "Lunch", start: o + "T12:00:00", className: "fc-event-info", description: "Lorem ipsum dolor sit amet, ut labore" },
                                            { title: "Meeting", start: o + "T14:30:00", className: "fc-event-warning", description: "Lorem ipsum conse ctetur adipi scing" },
                                            { title: "Happy Hour", start: o + "T17:30:00", className: "fc-event-info", description: "Lorem ipsum dolor sit amet, conse ctetur" },
                                            { title: "Dinner", start: s + "T05:00:00", className: "fc-event-solid-danger fc-event-light", description: "Lorem ipsum dolor sit ctetur adipi scing" },
                                            { title: "Birthday Party", start: s + "T07:00:00", className: "fc-event-primary", description: "Lorem ipsum dolor sit amet, scing" },
